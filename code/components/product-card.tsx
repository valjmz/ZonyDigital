        ...
        <div className="absolute top-4 left-4 z-20">
          <span
            className={cn(
              ...
              product.badge === "Back in stock" && "bg-primary/90 text-primary-foreground",
              product.badge === "Limited" && "bg-muted/90 text-muted-foreground",
            )}
          >
            {product.badge}
          </span>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6">
        ...
        <div className="relative z-10">
          <div>
            ...
            {product.price && <span className="text-xl font-bold text-white drop-shadow-sm">{product.price}</span>}
          </div>
        </div>
      </div>
    </motion.div>
